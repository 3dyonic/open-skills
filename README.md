...
Craft SoT — lean page [6:3](https://www.figma.com/design/Xa60SjtMsUZDYcIQyCKr1j/Open-Skills-%C2%B7-workshop-vision?node-id=6-3). **UI SoT is the attached Craft Ready lean PNGs for 6:5 / 6:68 / 6:107** (not opus 1:2 / 4:2):
